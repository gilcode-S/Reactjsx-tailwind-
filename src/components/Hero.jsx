  ...
  return (
    <div id="home" className='flex flex-col items-center gap-6 py-20 px-4 sm:px-12 lg:px-24 xl:px-40 text-center w-full overflow-hidden text-gray-700 dark:text-white'>
        <div className='inline-flex items-center gap-2 border border-gray-300 p-1.5 pr-4 rounded-full'>
            ...
            <p className='font-medium text-xs'>Trusted People</p>
        </div>

        <h1 className='text-4xl sm:text-5xl md:text-6xl lg:text-[85px] font-medium xl:leading-[95px] max-w-5xl'>Turning imagination into <span className='bg-gradient-to-r from-[#5044E4] to-[#4d8cea] bg-clip-text text-transparent'>digital</span> impact.</h1>
